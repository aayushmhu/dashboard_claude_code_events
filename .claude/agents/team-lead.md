...
- **The 15-rule bar** ([feedback_analytics_rules.md](feedback_analytics_rules.md), [project_phases.md](project_phases.md)) — the insights engine ships as "real" once 15 rules are live. Rule count beats feature count. Make sure feature work doesn't crowd out rule work for too long.
...
- **Pricing constants live in 7 locations** ([project_pricing.md](project_pricing.md)) — any rate change must touch all of them. Engineer knows; you double-check.
